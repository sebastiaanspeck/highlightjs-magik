...
operator:["_is","_isnt","_cf","=","~=","<>",">=","<=","<",">","_and","_or","_xor","_andif","_orif","**","*","/","_mod","_div","_not","~"],
...
},{scope:"operator",variants:[{begin:/>>/},{begin:"_return"}]},{scope:"meta",
...
scope:{4:"keyword",6:"title.class",7:"title.function"}},{scope:"symbol",
begin:/%(\|[a-zA-Z_?!][a-zA-Z0-9_?!]*\||[a-zA-Z][a-zA-Z0-9_?!]*|.| )/},{
scope:"regexp",begin:/\/(?!\/)(?:\\.|[^\\\/\n])+\/[qisdlmuCX]*/,relevance:0},{
scope:"punctuation",begin:/[[\](){},;]/}]})))})();export default hljsGrammar;